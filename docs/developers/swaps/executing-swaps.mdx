...
:::info
For more details about the swap, swap states, going through swap steps manually or getting the transactions to sign and send outside the SDK refer to the respective [Smart Chain → Bitcoin swap](/developers/swaps/smart-chain-to-btc).
:::
...
:::info
For more details about the swap, swap states, going through swap steps manually or getting the raw PSBT to sign outside the SDK refer to the respective [Bitcoin → Smart Chain swap](/developers/swaps/btc-to-smart-chain).
:::
...
:::info
For more details about the swap, swap states, going through swap steps manually or getting the transactions to sign and send outside the SDK refer to the respective [Lightning → Smart Chain swap](/developers/swaps/lightning-to-smart-chain).
:::
...
:::info
For more details about the swap, swap states, going through swap steps manually or getting the transactions to sign and send outside the SDK refer to the respective [Bitcoin → Smart Chain swap](/developers/swaps/btc-to-smart-chain).
:::
...
For complete end-to-end walkthroughs, see the swap tutorial pages in this section and the examples in `Multichain/sdk/README.md`.
