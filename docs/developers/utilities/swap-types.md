...
For an overview and background on various swap types, see [Swap Types](/developers/swaps/).
...
If you build your token selector by following [Supported Tokens](/developers/utilities/supported-tokens), you usually avoid these invalid combinations before `getSwapType()` is called.
:::
...
**[Supported Tokens →](/developers/utilities/supported-tokens)**
