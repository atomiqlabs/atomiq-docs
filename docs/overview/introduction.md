...
Learn how Atomiq works end to end: the actors in the protocol, the primitives that secure settlement, the swap flows they enable, and the smart contracts that implement them.

<DocCardList
  items={[
    {
      type: 'link',
      href: '/overview/actors/',
      label: 'Protocol Actors',
      description:
      'An overview of actors in the atomiq swap protocols.',
    },
    {
      type: 'link',
      href: '/overview/core-primitives/',
      label: 'Core Primitives',
      description:
        'Core primitives used in the atomiq swap protocols.',
    },
    {
      type: 'link',
      href: '/overview/swaps/',
      ...
      description:
        'Description of atomiq swap protocols.',
    },
    {
      type: 'link',
      href: '/overview/contracts/',
      label: 'Smart Contracts',
      description:
        'Smart contracts architecture, modules, and deployed addresses.',
    },
  ]}
/>
