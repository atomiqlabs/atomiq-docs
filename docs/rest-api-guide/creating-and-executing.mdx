...
:::info
Requesting gas-drop also affects spendable-balance math; see [Quoting Swaps → Spendable balance](/rest-api-guide/quoting#estimate-spendable-balance).
:::
...
:::info
A Lightning → Smart chain swap can also be settled via LNURL-withdraw instead of asking the user to pay an invoice — use the [LNURL-withdraw settlement](/rest-api-guide/bitcoin-and-lightning#settle-the-swap-with-lnurl-withdraw-link) instead.
:::
...
**[Listing Swaps →](/rest-api-guide/listing-swaps)**
