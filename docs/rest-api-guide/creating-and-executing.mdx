...
Details for each action type can be found at the `currentAction` field in the [`Response`](/rest-api-reference/get-swap-status#responses). Specific details for PSBTs and LNURL live in [Bitcoin & Lightning](/rest-api-guide/bitcoin-and-lightning).
