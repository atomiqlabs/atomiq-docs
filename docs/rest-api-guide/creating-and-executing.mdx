...
For **Bitcoin / Lightning → Smart chain** swaps, you can also request a destination-chain gas drop by passing `gasAmount`; see [Bitcoin & Lightning Specifics → Gas-drop](/rest-api-guide/bitcoin-and-lightning#gas-drop).
