...
:::info
By default, only initiated swaps are persisted. If you need to retrieve quotes that were created but not yet committed or executed, enable `saveUninitializedSwaps` in [Configuration](/sdk-guide/advanced/configuration#runtime-flags).
:::
...
- [Historical Swaps](/sdk-guide/swap-management/historical-swaps) - Retrieving persisted swaps
- [Configuration](/sdk-guide/advanced/configuration) - Runtime flags such as `saveUninitializedSwaps`, `noSwapCache`, and `storagePrefix`
...
**[Configuration →](/sdk-guide/advanced/configuration)**
