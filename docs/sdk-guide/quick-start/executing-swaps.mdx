...
For the full state machine and step-by-step manual processing, see [Swap Management → Refunds](/sdk-guide/swap-management/refunds) and [→ Claiming](/sdk-guide/swap-management/claiming), or the per-type pages under [Swap Types](/sdk-guide/swaps/).
