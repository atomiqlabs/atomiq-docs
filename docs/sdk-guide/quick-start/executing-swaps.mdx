...
:::info
- **Refunds** usually become available instantly if the LP is online and cooperates, unilateral refunds are possible in 4-5 days for Lightning or 12 hours for BTC L1.
- **Claims/Settlements** first wait for the automatic settlement via watchtowers (which is usually done in less than a minute), with the manual settlement path becoming available immediately after.
:::
